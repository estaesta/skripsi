...
% Sinyal ECG diubah ke dalam domain \textit{wavelet} dengan menggunakan \textit{wavelet transform}.
% \textit{Noise} pada sinyal ECG kemudian dapat dihilangkan dengan menghilangkan koefisien \textit{wavelet} yang memiliki nilai kecil.
